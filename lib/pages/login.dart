              ...
              children: [
                      ...
                      child: Column(
                        children: [
                          Text(
                            ...
                            style: kPoppinsBold.copyWith(color: Colors.white),
                          ),
                ...
                GestureDetector(
                  ...
                  child: Text(
                    ...
                    style: kPoppinsRegular.copyWith(color: Colors.white),
                  ),
                ),
                SizedBox(height: blockSize * 3),
...
createUserWithEmail(BuildContext context) async {
  ...
  try {
    ...
    bool userNameExists =
        await DbServices().checkuserNameExists(userNameCtrl.text.toLowerCase());
// New user
    if (userNameExists) {
      ...
      dbServices.addNewUser(FirebaseAuth.instance.currentUser!.displayName);

      await prefs.setBool(SharedPrefVal().userLoggedIn, true);
      Future.delayed(const Duration(seconds: 2), () {
        Get.to(() => ShowCaseWidget(
            builder: Builder(builder: (context) => const MainPage())));
      });
    }
